...
int main(int argc, char *argv[]) {
    ...
    cout << "Hospital C is up and running using UDP on port " << UDP_PORT << ".\n";
    cout << "Hospital C has total capacity " << capacity << " and initial occupancy " << occupancy << ".\n";
    ...
    while(true) {
        ...
        switch (phase) {
            ...
            case 2: {
                ...
                cout << "Hospital C has received input from client at location " << client_location << ".\n";
                ...
                if (locations.count(cl) == 0) {
                    ...
                    cout << "Hospital C does not have the location " << client_location << " in map.\n";
                    strcat(response, "3e;C;None;None；");
                    sendMessage(response, SCHEDULER_PORT);
                    cout << "Hospital C has sent \"location not found\" to the Scheduler.\n";
                } else {
                    ...
                    cout << "Hospital C has found the shortest path to client, distance = " << d_char << ".\n";
                    cout << "Hospital C has the score = " << s_char << ".\n";
                    ...
                    strcat(response, ";");
                    sendMessage(response, SCHEDULER_PORT);
                    cout << "Hospital C has sent score = " << s_char << " and distance = " << d_char << " to the Scheduler.\n";
                }
                break;
            }
            case 4:
                ...
                cout << "Hospital C has been assigned to a client, occupation is updated to " << occupancy 
